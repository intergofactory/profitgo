        ...
        if not penalty_df.empty:
            ...
            def penalty_status(row):
                ...
                if "iade" in order_status:
                    return "🟡 İade ile ilişkili"

                if "iptal" in order_status:
                    return "🟠 İptal ile ilişkili"

                if "yeni sipariş" in order_status:
                    return "🔴 ŞÜPHELİ - Yeni Sipariş"

                if "teslim" in order_status:
                    return "🔴 ŞÜPHELİ - Teslim Edilmiş"

                return "⚠️ İncelenmeli"
            ...
            penalty_df["ProfitGO Açıklama"] = penalty_df["ProfitGO Denetim"].map({
                "🔴 ŞÜPHELİ - Yeni Sipariş": "Sipariş Yeni Sipariş statüsünde olmasına rağmen ceza kesilmiş. Kesintinin nedeni doğrulanmalı.",
                "🔴 ŞÜPHELİ - Teslim Edilmiş": "Sipariş teslim edilmiş olmasına rağmen ceza kesilmiş. Ceza gerekçesi kontrol edilmeli.",
                "🟡 İade ile ilişkili": "Ceza iade süreciyle ilişkili görünüyor.",
                "🟠 İptal ile ilişkili": "Ceza iptal süreciyle ilişkili görünüyor.",
                "⚠️İncelenmeli": "Sipariş statüsünden cezanın nedeni kesin olarak belirlenemedi."
